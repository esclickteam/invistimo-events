...
const InboundSoftphoneBridgeAttemptSchema = new Schema<InboundSoftphoneBridgeAttemptDoc>(
  {
    bridgeAttemptId: {
      type: String,
      required: true,
      // Unique index created lazily via ensureInboundBridgeIndexes (safe if empty/dupes).
      index: true,
    },
