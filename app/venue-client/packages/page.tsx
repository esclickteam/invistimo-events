...
const VENUE_PACKAGES: VenuePackage[] = [
  ...
  },
  {
    ...
    subtitle: "כולל ניהול רשומות, אישורי הגעה, הודעות, שיחות ומתנות באשראי דרך ספק חיצוני.",
    badge: "מומלץ",
    basePrice: 0,
    pricePerRecord: 2,
    ...
    note: "עלות החבילה: 2 ₪ לכל רשומה. מתנות באשראי מופעלות דרך ספק חיצוני.",
  },
  {
    id: "full_event_management",
    title: "הושבה + אישורי הגעה + ניהול אירוע",
    subtitle: "חבילה מלאה הכוללת גם מערכת עצמאית לניהול ספקים, תקציב ומתנות באשראי דרך ספק חיצוני.",
    badge: "מלא",
    basePrice: 100,
    pricePerRecord: 2,
    requiresPayment: true,
    ...
    note: "עלות החבילה: 2 ₪ לכל רשומה + 100 ₪. מתנות באשראי מופעלות דרך ספק חיצוני.",
  },
];
