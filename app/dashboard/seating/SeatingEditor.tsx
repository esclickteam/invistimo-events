...
function SeatingEditorInner({
  ...
  return (
    <div
      ref={containerRef}
      className="
        relative z-0 w-full min-w-0 overflow-x-visible overflow-y-hidden
        bg-[radial-gradient(circle_at_top,#fffaf2_0%,#f8f1e7_34%,#efe8df_100%)]
      "
      style={{ height: "100dvh" }}
    >
      {/* Luxury canvas background */}
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(188,145,82,0.055)_1px,transparent_1px),linear-gradient(rgba(188,145,82,0.055)_1px,transparent_1px)] bg-[size:32px_32px]" />

        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(221,187,121,0.22),transparent_28%),radial-gradient(circle_at_80%_15%,rgba(255,255,255,0.75),transparent_26%),radial-gradient(circle_at_50%_90%,rgba(188,145,82,0.12),transparent_34%)]" />

        <div className="absolute left-8 right-8 top-8 h-px bg-gradient-to-r from-transparent via-[#d7b56d]/45 to-transparent" />
        <div className="absolute bottom-8 left-8 right-8 h-px bg-gradient-to-r from-transparent via-[#d7b56d]/30 to-transparent" />

        <div className="absolute left-8 top-8 h-20 w-20 rounded-tl-[32px] border-l border-t border-[#d7b56d]/30" />
        <div className="absolute right-8 top-8 h-20 w-20 rounded-tr-[32px] border-r border-t border-[#d7b56d]/30" />
        <div className="absolute bottom-8 left-8 h-20 w-20 rounded-bl-[32px] border-b border-l border-[#d7b56d]/24" />
        <div className="absolute bottom-8 right-8 h-20 w-20 rounded-br-[32px] border-b border-r border-[#d7b56d]/24" />
      </div>

      {/* Soft stage frame */}
      <div
        className="
          pointer-events-none absolute inset-4 z-[1]
          rounded-[34px] border border-[#ead8bf]/70
          bg-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.75),0_22px_80px_rgba(92,64,36,0.08)]
        "
      />
      ...
      {!readOnly && (
        <div
          className="
            pointer-events-none absolute left-6 top-6 z-[3]
            hidden rounded-2xl border border-[#ead8bf]/80
            bg-white/75 px-4 py-2 text-xs font-semibold text-[#8a755d]
            shadow-[0_14px_36px_rgba(92,64,36,0.10)]
            backdrop-blur-xl md:block
          "
        >
          גרירה להזזה · גלגלת לזום · לחיצה על שולחן לניהול
        </div>
      )}
      ...
      <div
        className="
          pointer-events-none absolute bottom-7 left-1/2 z-[3]
          hidden -translate-x-1/2 items-center gap-3
          rounded-2xl border border-[#ead8bf]/80 bg-white/78
          px-4 py-2 text-xs font-bold text-[#7a654d]
          shadow-[0_18px_46px_rgba(92,64,36,0.12)]
