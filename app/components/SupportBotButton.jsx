  ...
  return (
    <>
      {!open && (
        ...
        >
          {/* glow */}
          <span className="absolute inset-0 rounded-full bg-[#D8B16A]/30 blur-xl scale-110 -z-10" />

          {/* inner ring */}
          <span className="absolute inset-[6px] rounded-full border border-white/20" />
          ...
          <span className="relative flex items-center justify-center">
            ...
            >
              ...
              <path
                ...
                strokeLinecap="round"
              />
              <circle cx="12" cy="10" r="2.2" stroke="white" strokeWidth="1.8" />
            </svg>
          </span>
