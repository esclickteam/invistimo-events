...
const EASY_INCLUDES = [
  ...
  "מעקב פתיחת קישור בזמן אמת – ניתן לראות אילו אורחים פתחו את הקישור שנשלח אליהם, גם אם עדיין לא סימנו הגעה או מילאו אישור הגעה.",
...
const PACKAGE_PLANS: PackagePlan[] = [
  ...
  },
  {
    ...
    customerSummary:
      "חבילת מזמינים ומושיבים כוללת הזמנה דיגיטלית על בסיס קובץ שהלקוח מעלה, 2 סבבי הודעות ב־WhatsApp או SMS, הודעת תזכורת, הודעת תודה, מוקד טלפוני ועד 3 סבבי שיחה, מערכת הושבה דיגיטלית באתר לניהול שולחנות וסידורי הושבה, ומתנות באשראי באמצעות ספק חיצוני RSVP ללא תוספת תשלום.",
    employeeDetails: [
      {
        title: "דגשים לעובד",
        items: [
...
const DETAILED_VENUE_SEATING_CUSTOMER_DETAILS: DetailSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "שירות ההושבה נמשך לאורך שלב קבלת האורחים והכניסה לאולם, ועד לשלב המנה הראשונה או עד שכלל האורחים יושבים בצורה מסודרת — בהתאם להתנהלות האירוע בפועל. במקרים בהם המנה הראשונה מוגשת לפני החופה, השירות נמשך עד 4 שעות או עד שחרורם מהאירוע — לפי המוקדם מביניהם.",
    ],
  },
  {
...
const DETAILED_VENUE_SEATING_EMPLOYEE_DETAILS: DetailSection[] = [
  {
    ...
    items: [
      ...
      "להדגיש שהצוות מגיע כחצי שעה לפני תחילת האירוע ונשאר עד שלב המנה הראשונה או עד שכל האורחים יושבים בצורה מסודרת, בהתאם להתנהלות האירוע בפועל. במקרים בהם המנה הראשונה מוגשת לפני החופה — עד 4 שעות או עד שחרורם מהאירוע, לפי המוקדם מביניהם.",
  ...
  },
  {
    ...
    items: [
      ...
      "השירות נמשך עד שלב המנה הראשונה או עד שכל האורחים יושבים בצורה מסודרת. במקרים בהם המנה הראשונה מוגשת לפני החופה — עד 4 שעות או עד שחרורם מהאירוע, לפי המוקדם מביניהם.",
      "פתיחת רזרבות או התחייבות נוספת מול האולם תתבצע רק באישור נציג המשפחה או גורם מוסמך מטעם בעל האירוע.",
    ],
  },
];
...
const EVENT_DAY_MANAGER_CUSTOMER_DETAILS: DetailSection[] = [
  {
    title: "מנהל/ת אירוע – יום האירוע",
    items: [
      "פגישה מקדימה לפני האירוע לצורך מעבר על כלל הפרטים, תיאום ציפיות והיערכות ליום האירוע.",
      "ניהול לו״ז האירוע בפועל, לרבות קבלת פנים, כניסות, חופה, הגשת מנות, אטרקציות, ספקים וכל נקודת זמן משמעותית במהלך האירוע.",
      "טיפול מיידי בכל שינוי, צורך או תקלה בלתי צפויה במהלך האירוע.",
      "בדיקת מוכנות וניקיון האולם, לרבות קבלת הפנים, השירותים, הרחבה והאזורים המרכזיים.",
      "בדיקת סידור האולם וההושבה, כולל כמות וסידור השולחנות והכיסאות בהתאם לסקיצה ולהתחייבויות האולם.",
      "במידה ונבחרה חבילת עיצוב – בדיקה שהעיצוב בפועל, כולל השולחנות והחופה, תואם לחבילה שנבחרה.",
      "וידוא ותיאום הגעת כלל הספקים, כולל התקשרות מולם לפני האירוע וביום האירוע.",
      "בדיקת התאמת התפריט לבחירות הזוג, הן בקבלת הפנים ובבופה והן במנות המוגשות במהלך האירוע.",
      "טיפול וסידור פריטים שיש להוציא, להציב או להכין באזור הבר, הרחבה או באזורים נוספים באולם.",
      "טיפול בנושא הכתובה ווידוא שכל האנשים הנדרשים נמצאים במקום בזמן המתאים.",
      "תדרוך החתן והכלה לקראת הכניסה לחופה, ריכוז המשתתפים הרלוונטיים ותיאום הכניסה והעמידה תחת החופה.",
      "ניהול ופיקוח על ההושבה במהלך האירוע, כולל פתיחת רזרבות בהתאם לצורך ולשיקול דעת מקצועי, בנוסף לצוות ההושבה.",
      "מעבר שוטף בין האורחים ובין אזורי האירוע לצורך בקרה על רמת השירות, שביעות רצון האורחים והתנהלות האירוע.",
      "העברת מעטפות ותשלומים לספקים בסיום הערב בהתאם להנחיות הזוג.",
    ],
  },
];
...
const UPSELLS: UpsellItem[] = [
  ...
  },
  {
    ...
    description: "קישור מתנות באשראי באמצעות ספק חיצוני RSVP. בחבילת מזמינים ומושיבים השירות כלול ללא תוספת תשלום.",
    ...
    employeeDetails: [
      {
        ...
        items: [
          ...
          "בחבילת מזמינים ומושיבים מתנות באשראי מופיע באפסיילים במחיר 0 ₪ כי הוא כבר כלול בחבילה.",
          "להבהיר ללקוח שהשירות מתבצע דרך ספק חיצוני בשם RSVP, ולא מופעל ישירות על ידי Invistimo.",
          "הלקוח חייב להשלים הרשמה ל־RSVP, למלא פרטים ולהעביר מסמכים אם יידרשו. אישור פתיחת משתמש מתבצע עד 2 ימי עסקים ממועד השלמת כל הפרטים.",
          "לאחר קבלת הקישור מ־RSVP חובה להוסיף את הקישור בפרטי האירוע במערכת Invistimo ובהודעות לאורחים. בלי הקישור השירות לא יוצג לאורחים.",
          "עמלת סליקה: 2.5% מכל מתנה באשראי, משולמת על ידי האורח במעמד התשלום.",
          "הכספים מועברים לחשבון הבנק שהוגדר ב־RSVP עד 5 ימי עסקים, לפי מדיניות הספק.",
          "אפשר לבקש העברת זהב מהירה בעלות 100 ₪ עד יום עסקים אחד, בכפוף לזמינות ולאישור RSVP.",
          "Invistimo אחראית לשילוב הקישור במערכת ובהודעות בלבד. ההרשמה, אישור המשתמש, הסליקה, העמלות והעברת הכספים מתבצעים על ידי RSVP.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    title: "מנהל/ת אירוע – יום האירוע",
    price: 3000,
    description: "ניהול ופיקוח ביום האירוע באולם, כולל לו״ז, ספקים, הושבה וטיפול בשינויים.",
    customerDetails: EVENT_DAY_MANAGER_CUSTOMER_DETAILS,
    employeeDetails: [
      {
        title: "דגשים לעובד",
        items: [
          "להסביר שזה שירות פיזי באולם ביום האירוע, ולא ליווי מרחוק.",
          "אם הלקוח רוצה גם ליווי מרחוק לפני האירוע — לבחור בנוסף נציג אישי לליווי.",
          "המחיר הוא 3,000 ₪ והתשלום מטופל כשירות יום האירוע.",
        ],
      },
    ],
  },
...
function isEventDayService(key: UpsellKey) {
  return key === "venueSeating" || key === "alcoholManagement" || key === "eventDayManager";
}
...
function getEmployeeDetailsForPlan(plan: PackagePlan): DetailSection[] {
  ...
  if (plan.key === "seating") {
    sections.push({
      ...
      items: [
        "בחבילת מזמינים ומושיבים מתנות באשראי כלולות בחבילה ללא תוספת תשלום ומופיעות באפסיילים במחיר 0 ₪.",
        "השירות מתבצע באמצעות ספק חיצוני בשם RSVP ואינו מופעל ישירות על ידי Invistimo.",
        "הלקוח צריך להירשם ל־RSVP, למלא את כל הפרטים ולהעביר מסמכים אם יידרשו. פתיחת המשתמש מאושרת עד 2 ימי עסקים לאחר השלמת כל הדרישות.",
        "לאחר קבלת הקישור מ־RSVP, חובה להוסיף אותו בפרטי האירוע ובהודעות הנשלחות לאורחים כדי שהאורחים יראו את אפשרות התשלום באשראי.",
        "עמלת 2.5% נגבית מכל מתנה באשראי ומשולמת על ידי האורח במעמד התשלום.",
        "העברת הכספים לחשבון שהוגדר ב־RSVP מתבצעת עד 5 ימי עסקים. העברת זהב מהירה אפשרית בעלות 100 ₪, עד יום עסקים אחד, בכפוף לזמינות ולאישור RSVP.",
        "Invistimo מאפשרת את שילוב הקישור במערכת ובהודעות בלבד. הסליקה, העמלות והעברת הכספים הן באחריות RSVP ובהתאם לתנאי הספק.",
      ],
    });
  }
                  ...
                  return (
                    <div key={upsell.key} className={`rounded-[26px] border p-4 transition ${selected ? "border-[#b47a3b] bg-[#fff7ec]" : "border-[#eadfce] bg-white"}`}>
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="shrink-0 text-left text-sm font-black text-[#3f3327]">{includedInPackage ? money(0) : freeApplied ? "ללא עלות" : money(getEffectiveUpsellPrice(upsell))}</div>
                      </div>

                      {selected && !freeApplied && !includedInPackage ? (
