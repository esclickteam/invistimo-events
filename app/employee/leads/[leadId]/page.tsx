    ...
    >
      <div className="mx-auto w-full max-w-[1380px] space-y-6">
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-5 space-y-4">
              ...
              <button
                ...
                onClick={saveLead}
                disabled={saving}
                className="h-12 w-full rounded-2xl bg-slate-950 px-5 text-sm font-black text-white transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
              >
                ...
                <div className="space-y-3">
                  {messages.map((message) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`max-w-[82%] rounded-[1.25rem] px-4 py-3 shadow-sm ${
                            isOutgoing
                              ? isFailed
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          <h2 className="text-xl font-black">פעולות נוספות</h2>

          <div className="mt-4 flex flex-wrap gap-2">
            <Link
              href={`/admin/customers/${leadId}`}
              className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black text-slate-700 transition hover:bg-slate-50"
            >
              פתיחה בתיק לקוח אדמין
            </Link>
